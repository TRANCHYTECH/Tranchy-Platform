...
{
    public static async Task Send<T>(this ISendEndpointProvider sendEndpointProvider, T command, string queue,
        CancellationToken cancellationToken) where T : ICommand
    {
