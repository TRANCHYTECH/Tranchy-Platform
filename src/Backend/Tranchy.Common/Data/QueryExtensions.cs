...
public static class QueryExtensions
{
    ...
    public static Find<T, TProjection> Other<T, TProjection>(this Find<T, TProjection> find, string id, ITenant tenant) where T : Entity, IOwnEntity => find.Match(e => e.ID == id && e.CreatedByUserId != tenant.UserId);
}
