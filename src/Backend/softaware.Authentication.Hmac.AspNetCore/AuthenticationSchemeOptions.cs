...
namespace softaware.Authentication.Hmac.AspNetCore
{
    public class HmacAuthenticationSchemeOptions : AuthenticationSchemeOptions
    {
        ...
        private IDictionary<string, string> _hmacAuthenticatedApps = new Dictionary<string, string>(StringComparer.Ordinal);
        ...
        {
            get { return this._hmacAuthenticatedApps; }
            set
            {
                this._hmacAuthenticatedApps = value;

                // temporary backwards compatible solution as long as we support HmacAuthenticatedApps.
                this.AuthorizationProvider = new MemoryHmacAuthenticationProvider(this._hmacAuthenticatedApps);
            }
        }
